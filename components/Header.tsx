...
export default function Header({ onSpotifyConnect, connected, onLogout, onAutoFill }: HeaderProps) {
                ...
                {!connected ? (
                  <div className="relative">
                    ...
                    <div className="absolute top-full right-0 mt-2 w-48 p-2 bg-gray-800 border border-gray-700 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 sm:hidden">
                      <p className="text-xs text-gray-300 text-center">Contact dev to connect your Spotify</p>
                  ...
                  <>
                    <button
                      ...
                      className="bg-gray-700 hover:bg-gray-600 text-white font-semibold py-2 px-3 rounded-lg transition-all duration-200 text-sm"
                    >
                      Auto-Fill Top Artists
                    </button>
                    <button
                      onClick={handleLogoutClick}
                      className="bg-red-600 hover:bg-red-500 text-white font-semibold py-2 px-3 rounded-lg transition-all duration-200 text-sm"
                    >
                      Logout
                    </button>
                  </>
